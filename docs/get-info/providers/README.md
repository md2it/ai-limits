...
2. Structured data
   ...
   The same source data converted to the common contract from [docs/get-info/structured-info.md](../structured-info.md).
...
- Missing, unavailable, or unreliable values must follow [docs/get-info/structured-info.md](../structured-info.md).
