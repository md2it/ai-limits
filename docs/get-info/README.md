...
This section describes one product process: retrieving usage, limits, reset, quota, billing, model, and authorization information from local or remote AI-related sources.

The documentation has two axes:
