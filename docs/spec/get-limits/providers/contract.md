...
2. Structured data
   ...
   The same source data converted to the common contract from [structured-info.md](../structured-info.md).
...
- Missing, unavailable, or unreliable values must follow [structured-info.md](../structured-info.md).
